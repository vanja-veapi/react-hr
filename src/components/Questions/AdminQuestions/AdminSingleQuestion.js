        ...
        <div className="d-flex container justify-content-between border my-3">
            <div className="px-3  d-flex ">
                <div className="d-flex py-3 flex-column justify-content-between">
                    <button className="btn p-0 m-1" onClick={() => props.orderUp(props.id)}><FaArrowUp size={20} /></button>
                    <button className="btn p-0 m-1" onClick={() => props.orderDown(props.id)}><FaArrowDown size={20} /></button>
                </div>
            ...
            <div className="d-flex align-items-baseline align-content-center my-auto">
                <button className="btn btn-primary px-4 m-2 align-items-start" onClick={handleEdit}>Edit</button>
